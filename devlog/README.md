...
|------|-------|----------------|
| 2026-08-09 | [Sorties become treks](2026-08-09-sorties-become-treks.md) | Military framing out, camping in: trek/survey/search party; survivor and dispatcher retired; 14 proposed renames triaged to 3 (operational vs narrative vs tool-name terms); the seam placed on user surfaces, frozen off experimental ones (prompts, archive paths, verdicts) |
| 2026-08-09 | [The harness never imports its cargo](2026-08-09-the-harness-never-imports-its-cargo.md) | Desplopify finds the slop in the sortie-built code (−44 lines); the crude_* "placeholders" declared permanent — scout.py never imports scoutlib (trust boundary, not unfinished migration); rearchitecting rejected: generic layout is blinding, paths are frozen conditions |
